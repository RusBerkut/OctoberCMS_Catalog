...
use Radit\Catalog\Models\Coupon as Coupon;
...
{   
     ...
     */
    public $table = 'radit_shop_orders';
	...
	public function afterValidate()
	{
		...
		*/
		if($this->coupon_id)
		{
			$coupon = Coupon::where('id', '=', $this->coupon_id)->where('products_id', '=', $this->product_id)->first();
			if($coupon==null)
			{	
	...
	public function afterSave()
	{
		...
		*/
		Coupon::where('id', '=', $this->coupon_id)->where('products_id', '=', $this->product_id)->update(array('is_used' => $this->coupon_id));
	}
	...
	public function afterDelete()
	{
		...
		*/
		Coupon::where('id', '=', $this->coupon_id)->where('products_id', '=', $this->product_id)->delete();
	}
