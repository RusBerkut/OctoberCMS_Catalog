...
use Radit\catalog\Models\Order as Order;
use Radit\catalog\Models\Currency as Currency;
use Radit\catalog\Models\Settings as Settings;
    ...
    Route::get('order/webmoney/wmz', function()
    {
         ...
         */         
         else
         {
              ...
              */
              Mail::sendTo(post('SHOP_USER_EMAIL'), 'radit.catalog::mail.license', $product);
